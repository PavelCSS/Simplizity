...
var start=function(a){timer||($el=$(a.target),timer=window.setTimeout(function(){$el.addClass("touch")},50))},stop=function(a){timer&&(window.clearTimeout(timer),timer=null,$el=$(a.target),setTimeout(function(){$el.removeClass("touch")},10))};$("body").on(events[0],start);$("body").on(events[1],stop);$(".dropdown-btn").each(function(){var a=$(this).data("menu"),b=$(this).data("menu-position"),d=$(this).data("menu-height");$(a).addClass("dropdown-menu "+b).height(d)});$(document).on("singleTap",".menu-btn",function(a){event.preventDefault();showMenu($(this))}).on("singleTap",".dropdown-btn",function(){event.preventDefault();showDropdown($(this))}).on("singleTap",".sub-menu-btn",function(){event.preventDefault();$(this).toggleClass("active").nextAll("ul").toggleClass("open")});
