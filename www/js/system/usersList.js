...
var usersSent = randomUser(),
    usersBirthday = randomUser();

function randomWish(){
    var i = 0, wishIndex = [], newWishList = [];
    while (i < Math.floor((Math.random() * wishList.length))) {
        i++;
